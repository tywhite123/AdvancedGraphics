...
void Renderer15::UpdateScene(float msec)
{
...
void Renderer15::DrawPointLights()
{
	...
	Vector3 translate = Vector3((RAW_WIDTH*HEIGHTMAP_X / 2.0f), 500.0f, (RAW_HEIGHT*HEIGHTMAP_Z / 2.0f));
...
void Renderer15::CombineBuffers()
{
...
void Renderer15::GenerateScreenTexture(GLuint & into, bool depth)
{
