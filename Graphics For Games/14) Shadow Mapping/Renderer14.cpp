...
Renderer14::Renderer14(Window & parent) : OGLRenderer(parent)
{
	camera = new Camera(-8.0f, 40.0f, Vector3(-100.0f, 50.0f, 250.0f));

	light = new Light(Vector3(-450.0f, 1000.0f, 280.0f), Vector4(1, 1, 1, 1), 5500.0f, SPOT);
...
Renderer14::~Renderer14()
{
	...
	glDeleteFramebuffers(1, &shadowTex);
	delete camera;
	delete light;
	delete hellData;
	delete hellNode;
...
void Renderer14::UpdateScene(float msec)
{
...
void Renderer14::DrawShadowScene()
{
	glBindFramebuffer(GL_FRAMEBUFFER, shadowFBO);
...
void Renderer14::DrawCombinedScene()
{
